...
export default function FeaturedProducts() {
  ...
  return (
    <div>
        ...
        <div className="w-52 h-52 rounded-full bg-purple-700 absolute -top-40 -z-10 left-10 bg-opacity-10"></div>
            ...
            <div className="w-52 h-52 rounded-full bg-purple-700 absolute bottom-0 right-10 bg-opacity-15"></div>
        </div>
        </div>
    </div>
  )
